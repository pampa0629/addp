...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_addp_system_internal_models.ConfigurationManagementEntryView"
                            }
                        }
                    },
                    "401": {
        ...
        "/engine-types": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "可注册引擎类型数组 | Registerable engine type array",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/plugin.EngineTypeDescriptor"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogListChildrenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogListChildrenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogDescribeFactsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/plugin.EngineCatalogFacts"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMNotebookEngineCatalogChildrenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/oauth/token": {
            "post": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "暂时无法签发有效令牌 | Temporarily unable to issue a valid token",
                        "schema": {
                            "$ref": "#/definitions/fosite.RFC6749ErrorJson"
                        }
                    }
                },
                "x-addp-auth-mode": "public"
        ...
        "/platform/security_policy": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMSecurityPolicyResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "IAM 安全策略 | IAM security policy",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateSecurityPolicyRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.RuntimeEngineRegistrationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/runtime/modules": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "模块状态过滤 | Module status filter",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "default": 0,
                        "description": "客户端当前修订号 | Client current revision",
                        "name": "revision",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "default": 10,
                        "description": "最长等待秒数，范围 0-30 | Maximum wait in seconds, range 0-30",
                        "name": "wait_seconds",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_system_internal_models.ModuleRoutingSnapshot"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/runtime/modules/{module_name}/instances/{instance_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "运行实例 ID | Runtime instance ID",
                        "name": "instance_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/runtime/security-access-actors/resolve": {
            "post": {
                ...
                "tags": [
                    "Runtime Security Access Actors"
                ],
        ...
        "/tenant/departments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "编码或名称 | Code or name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "状态：active/disabled | Status: active/disabled",
                        "name": "status",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/internal_api.IAMDepartmentResponse"
                                    }
                                },
                                "page": {
                                    "type": "integer"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "部门定义 | Department definition",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/departments/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "部门 ID | Department ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "完整可编辑聚合与版本 | Full editable aggregate and version",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/departments/{id}/memberships": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "状态：active/ended | Status: active/ended",
                        "name": "status",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "成员关系 | Membership",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateDepartmentMembershipRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/departments/{id}/memberships/{membership_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "关系与版本 | Relationship and version",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateDepartmentMembershipRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/departments/{id}/memberships/{membership_id}/close": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/oauth_clients": {
            "get": {
                ...
                "tags": [
                    "租户 OAuth 客户端 | Tenant OAuth Clients"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "客户端 ID 或名称 | Client ID or name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/internal_api.IAMOAuthClientResponse"
                                    }
                                },
                                "page": {
                                    "type": "integer"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "客户端定义 | Client definition",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateOAuthClientRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/oauth_clients/{client_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "客户端定义与版本 | Client definition and version",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateOAuthClientRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/oauth_clients/{client_id}/restore": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/oauth_clients/{client_id}/suspend": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/project_groups": {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/internal_api.IAMProjectGroupResponse"
                                    }
                                },
                                "page": {
                                    "type": "integer"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "项目组定义 | Project group definition",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateProjectGroupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/project_groups/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "项目组 ID | Project group ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateProjectGroupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/project_groups/{id}/close": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/project_groups/{id}/memberships": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateProjectGroupMembershipRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/project_groups/{id}/memberships/{membership_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "组内角色与版本 | Group role and version",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateProjectGroupMembershipRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/project_groups/{id}/memberships/{membership_id}/close": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/role_assignments": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "授权范围不存在或不属于当前租户 | Assignment scope not found in the current tenant",
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMErrorResponse"
                        }
                    },
                    "409": {
                        "description": "角色分配冲突：重复分配、主体类型不兼容、授权范围不可用或缺少组织成员关系 | Role assignment conflict: duplicate assignment, incompatible principal type, unavailable scope, or missing organization membership",
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMErrorResponse"
                        }
                    }
        ...
        "/tenant/roles": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "请求参数无效；标识格式错误码为 role_key_invalid | Invalid request; invalid key format uses role_key_invalid",
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMErrorResponse"
                        }
                    }
        ...
        "/tenant/service_accounts": {
            "get": {
                ...
                "tags": [
                    "租户服务账号 | Tenant Service Accounts"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "名称、说明或 Client ID | Name, description, or client ID",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/internal_api.IAMServiceAccountResponse"
                                    }
                                },
                                "page": {
                                    "type": "integer"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "服务账号定义 | Service account definition",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMCreateServiceAccountRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMServiceAccountCredentialResponse"
                        }
                    }
                },
                "x-addp-auth-mode": "permission",
        ...
        "/tenant/service_accounts/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "服务账号 ID | Service account ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "定义与版本 | Definition and version",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.IAMUpdateServiceAccountRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tenant/service_accounts/{id}/restore": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/service_accounts/{id}/rotate-secret": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/tenant/service_accounts/{id}/suspend": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "configuration.ManagementDeclaration": {
            "type": "object",
            "properties": {
                "entries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/configuration.ManagementEntry"
                    }
                },
                "schema_version": {
                    "type": "string"
        ...
        "github_com_addp_system_internal_iam.DepartmentMembershipType": {
            "type": "string",
            "enum": [
                "primary",
                "additional"
            ...
            "x-enum-varnames": [
                "DepartmentMembershipTypePrimary",
                "DepartmentMembershipTypeAdditional"
            ]
        },
        "github_com_addp_system_internal_iam.DepartmentRelationRole": {
            "type": "string",
            "enum": [
                "member",
                "leader"
            ...
            "x-enum-varnames": [
                "DepartmentRelationRoleMember",
                "DepartmentRelationRoleLeader"
            ]
        },
        "github_com_addp_system_internal_iam.DepartmentStatus": {
            "type": "string",
            "enum": [
                "active",
                "disabled"
        ...
        "github_com_addp_system_internal_iam.OAuthClientStatus": {
            "type": "string",
            "enum": [
                "active",
                "disabled"
            ...
            "x-enum-varnames": [
                "OAuthClientStatusActive",
                "OAuthClientStatusDisabled"
            ]
        },
        "github_com_addp_system_internal_iam.OrganizationMembershipStatus": {
            "type": "string",
            "enum": [
                "active",
                "ended"
            ...
            "x-enum-varnames": [
                ...
                "OrganizationMembershipStatusEnded"
            ]
        },
        ...
        "github_com_addp_system_internal_iam.ProjectGroupRelationRole": {
            "type": "string",
            "enum": [
                "member",
                "leader",
            ...
            "x-enum-varnames": [
                "ProjectGroupRelationRoleMember",
                "ProjectGroupRelationRoleLeader",
                "ProjectGroupRelationRoleCoordinator"
            ]
        },
        ...
        "github_com_addp_system_internal_models.ConfigurationManagementEntryView": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "github_com_addp_system_internal_models.EngineCatalogDescribeFactsRequest": {
            "type": "object",
            "properties": {
                "path": {
                    "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogPath"
                }
            }
        },
        "github_com_addp_system_internal_models.EngineCatalogEntry": {
            "type": "object",
            "properties": {
                "kind": {
                    "type": "string",
        ...
        "github_com_addp_system_internal_models.EngineCatalogListChildrenRequest": {
            "type": "object",
            "properties": {
                "options": {
                    "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogListOptions"
                },
                "path": {
                    "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogPath"
                }
        ...
        "github_com_addp_system_internal_models.EngineCatalogListChildrenResponse": {
            "type": "object",
            "properties": {
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogEntry"
                    }
                }
            }
        },
        "github_com_addp_system_internal_models.EngineCatalogListOptions": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer",
        ...
        "github_com_addp_system_internal_models.EngineCatalogPath": {
            "type": "object",
            "properties": {
                "engine_id": {
                    "type": "integer",
                ...
                "segments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_system_internal_models.EngineCatalogSegment"
                    }
                },
                "version": {
                    "type": "string",
        ...
        "github_com_addp_system_internal_models.EngineCatalogSegment": {
            "type": "object",
            "properties": {
                "kind": {
                    "type": "string",
        ...
        "github_com_addp_system_internal_models.ModuleRoutingSnapshot": {
            "type": "object",
            "properties": {
                "modules": {
                    "type": "array",
        ...
        "internal_api.CreateExecuteTaskRequest": {
            ...
            "properties": {
                ...
                "external_artifact_policy": {
                    "description": "物理回收必须显式选择：delete/abandon",
                    "type": "string",
                    "enum": [
                        "delete",
                        "abandon"
        ...
        "internal_api.IAMCatalogReferenceBatchRequest": {
            "type": "object",
            "properties": {
                "references": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.IAMCatalogReferenceRequest"
                    }
                }
            }
        },
        "internal_api.IAMCatalogReferenceBatchResponse": {
            "type": "object",
            "properties": {
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.IAMCatalogReferenceResolution"
                    }
                }
            }
        },
        ...
        "internal_api.IAMCatalogReferenceResolution": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_api.IAMCreateDepartmentMembershipRequest": {
            "type": "object",
            "properties": {
                "membership_type": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.DepartmentMembershipType"
                },
                "relation_role": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.DepartmentRelationRole"
                },
                "tenant_membership_id": {
                    "type": "string"
                }
        ...
        "internal_api.IAMCreateOAuthClientRequest": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
        ...
        "internal_api.IAMCreateProjectGroupMembershipRequest": {
            "type": "object",
            "properties": {
                "relation_role": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.ProjectGroupRelationRole"
                },
                "tenant_membership_id": {
                    "type": "string"
                }
        ...
        "internal_api.IAMCreateProjectGroupRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_api.IAMCreateServiceAccountRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "internal_api.IAMDepartmentResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
                ...
                "status": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.DepartmentStatus"
                },
                "updated_at": {
                    "type": "string"
                },
        ...
        "internal_api.IAMExecutionAuthorizationResponse": {
            ...
            "properties": {
                "accesses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.IAMExecutionEngineAccessScope"
                    }
                },
                "actor_principal_id": {
                    "type": "string"
        ...
        "internal_api.IAMExecutionEngineAccessScope": {
            "type": "object",
            "properties": {
                "effects": {
                    "type": "array",
        ...
        "internal_api.IAMNotebookEngineCatalogChildrenRequest": {
            "type": "object",
            "properties": {
                "engine_id": {
                    "type": "integer"
        ...
        "internal_api.IAMOAuthClientResponse": {
            "type": "object",
            "properties": {
                "allowed_audiences": {
                    "type": "array",
                ...
                "status": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.OAuthClientStatus"
                },
        ...
        "internal_api.IAMOrganizationMembershipResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "status": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.OrganizationMembershipStatus"
                },
                "tenant_membership_id": {
                    "type": "string"
                },
        ...
        "internal_api.IAMProjectGroupResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_api.IAMServiceAccountCredentialResponse": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "internal_api.IAMServiceAccountResponse": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "internal_api.IAMUpdateDepartmentMembershipRequest": {
            "type": "object",
            "properties": {
                "membership_type": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.DepartmentMembershipType"
        ...
        "internal_api.IAMUpdateDepartmentRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "internal_api.IAMUpdateOAuthClientRequest": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
        ...
        "internal_api.IAMUpdateProjectGroupMembershipRequest": {
            "type": "object",
            "properties": {
                "relation_role": {
                    "$ref": "#/definitions/github_com_addp_system_internal_iam.ProjectGroupRelationRole"
        ...
        "internal_api.IAMUpdateProjectGroupRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "internal_api.IAMUpdateSecurityPolicyRequest": {
            "type": "object",
            "properties": {
                "access_token_ttl_minutes": {
                    "type": "integer"
        ...
        "internal_api.IAMUpdateServiceAccountRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "internal_api.IAMVersionedLifecycleRequest": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string"
        ...
        "internal_api.RuntimeEngineRegistrationRequest": {
            "type": "object",
            "required": [
                "connection_info",
                "engine_type",
        ...
        "plugin.ComputeCapabilities": {
            "type": "object",
            "properties": {
                "inference": {
                    "$ref": "#/definitions/plugin.InferenceCapability"
                },
                "query": {
                    "$ref": "#/definitions/plugin.QueryCapability"
                },
                "script": {
                    "$ref": "#/definitions/plugin.ScriptCapability"
                },
                "workflow": {
                    "$ref": "#/definitions/plugin.WorkflowCapability"
                }
            }
        },
        "plugin.ConnectionConstraintSpec": {
            "type": "object",
            "properties": {
                "fields": {
                    "type": "array",
                ...
                "when": {
                    "$ref": "#/definitions/plugin.ConnectionFieldCondition"
                }
            }
        },
        "plugin.ConnectionFieldCondition": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "plugin.ConnectionFieldSpec": {
            ...
            "properties": {
                ...
                "options": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/plugin.ConnectionFieldOption"
                    }
                },
                "placeholder": {
                    "type": "string"
        ...
        "plugin.ConnectionSpec": {
            "type": "object",
            "properties": {
                "constraints": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/plugin.ConnectionConstraintSpec"
                    }
                },
                "default_port": {
                    "type": "integer"
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/plugin.ConnectionFieldSpec"
                    }
                },
                "schema_version": {
                    "type": "string"
        ...
        "plugin.EngineCapabilities": {
            "type": "object",
            "properties": {
                "compute": {
                    "$ref": "#/definitions/plugin.ComputeCapabilities"
                },
                "engine_family": {
                    "type": "string"
                },
                ...
                "storage": {
                    "$ref": "#/definitions/plugin.StorageCapabilities"
                }
            }
        },
        "plugin.EngineCatalogCapability": {
            "type": "object",
            "properties": {
                "node_kinds": {
                    "type": "array",
        ...
        "plugin.EngineCatalogFactsCapability": {
            "type": "object",
            "properties": {
                "constraints": {
                    "type": "boolean"
        ...
        "plugin.EngineCatalogModelSpec": {
            "type": "object",
            "properties": {
                "levels": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/plugin.EngineCatalogLevelSpec"
                    }
                },
                "path_version": {
                    "type": "string"
        ...
        "plugin.EngineTypeDescriptor": {
            "type": "object",
            "properties": {
                "capabilities": {
                    "$ref": "#/definitions/plugin.EngineCapabilities"
                },
                "catalog_model": {
                    "$ref": "#/definitions/plugin.EngineCatalogModelSpec"
                },
                "connection_spec": {
                    "$ref": "#/definitions/plugin.ConnectionSpec"
                },
                "display_name": {
                    "type": "string"
                },
        ...
        "plugin.NativeTableSpatialEncodingCapability": {
            "type": "object",
            "properties": {
                "geometry_read_encodings": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                },
                "geometry_write_encodings": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                },
                "native_spatial_functions": {
                    "type": "boolean"
                },
                "read_transform": {
                    "type": "boolean"
        ...
        "plugin.PartitionedTableChangeApplyCapability": {
            "type": "object",
            "properties": {
                "atomic_position_commit": {
                    "type": "boolean"
                },
                "monotonic": {
                    "type": "boolean"
        ...
        "plugin.QueryCapability": {
            ...
            "properties": {
                ...
                "parameters": {
                    "$ref": "#/definitions/plugin.QueryParameterCapability"
                },
                "read_only": {
                    "type": "boolean"
                },
        ...
        "plugin.QueryFederationCapability": {
            "type": "object",
            "properties": {
                "object_formats": {
                    "type": "array",
        ...
        "plugin.QueryParameterCapability": {
            "type": "object",
            "properties": {
                "languages": {
                    "type": "array",
        ...
        "plugin.StorageCapabilities": {
            "type": "object",
            "properties": {
                "catalog": {
                    "$ref": "#/definitions/plugin.EngineCatalogCapability"
                },
                "catalog_model": {
                    "$ref": "#/definitions/plugin.EngineCatalogModelSpec"
                },
                "facts": {
                    "$ref": "#/definitions/plugin.EngineCatalogFactsCapability"
                },
                "not_supported": {
                    "type": "array",
                    "items": {
                ...
                "store": {
                    "$ref": "#/definitions/plugin.StoreCapability"
                }
            }
        },
        "plugin.StoreCapability": {
            "type": "object",
            "properties": {
                "batch_read": {
                    "type": "boolean"
                ...
                "bounded_watermark_read": {
                    "type": "boolean"
                },
                "change_stream_read": {
                    "$ref": "#/definitions/plugin.ChangeStreamReadCapability"
                },
                "delete": {
                    "type": "boolean"
                },
                ...
                "table_read_spatial_transform": {
                    "type": "boolean"
                },
                "table_spatial_encoding": {
                    "$ref": "#/definitions/plugin.NativeTableSpatialEncodingCapability"
                },
                "table_upsert": {
                    "$ref": "#/definitions/plugin.TableUpsertCapability"
                },
                "table_write_prepare": {
                    "type": "boolean"
                },
