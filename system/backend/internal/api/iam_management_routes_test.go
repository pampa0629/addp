...
func TestRegisterIAMManagementRoutes(t *testing.T) {
	...
	want := []string{
		...
		"GET /api/v1/system/tenant/departments",
		"GET /api/v1/system/tenant/departments/:id",
		"GET /api/v1/system/tenant/departments/:id/memberships",
		...
		"GET /api/v1/system/tenant/project_groups/:id",
		"GET /api/v1/system/tenant/project_groups/:id/memberships",
		...
		"POST /api/v1/system/tenant/departments",
		"POST /api/v1/system/tenant/departments/:id/disable",
		"POST /api/v1/system/tenant/departments/:id/memberships",
		"POST /api/v1/system/tenant/departments/:id/memberships/:membership_id/close",
		"POST /api/v1/system/tenant/departments/:id/restore",
		...
		"POST /api/v1/system/tenant/oauth_clients",
		"POST /api/v1/system/tenant/oauth_clients/:client_id/restore",
		"POST /api/v1/system/tenant/oauth_clients/:client_id/suspend",
		"POST /api/v1/system/tenant/invitations",
		"POST /api/v1/system/tenant/invitations/:id/revoke",
		"POST /api/v1/system/tenant/project_groups",
		"POST /api/v1/system/tenant/project_groups/:id/close",
		"POST /api/v1/system/tenant/project_groups/:id/memberships",
		"POST /api/v1/system/tenant/project_groups/:id/memberships/:membership_id/close",
		...
		"PUT /api/v1/system/tenant/departments/:id",
		"PUT /api/v1/system/tenant/departments/:id/memberships/:membership_id",
		"PUT /api/v1/system/tenant/memberships/:id",
		"PUT /api/v1/system/tenant/oauth_clients/:client_id",
