...
INSERT INTO system.permissions (
    ...
    'transfer.execution.create', 'transfer', 'create', 'medium', false,
    ARRAY['tenant']::text[], false,
    'permissions.transfer.execution.create.name',
    'permissions.transfer.execution.create.description', 'active'
)
...
JOIN system.permissions permission
  ON permission.permission_key = 'transfer.execution.create'
