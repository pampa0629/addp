...
INSERT INTO system.roles (
    ...
    'platform.portal_runtime', 'roles.platform.portal_runtime.name',
    'roles.platform.portal_runtime.description', 'platform_builtin',
...
SELECT service_principal.id, role.id, 'platform', 'active', transaction_timestamp(),
       'bootstrap', 'built-in Portal control plane runtime'
