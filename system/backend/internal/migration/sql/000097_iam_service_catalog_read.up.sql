...
VALUES (
    'service.catalog.read', 'service', 'read', 'low', false,
    ARRAY['tenant']::text[], false,
    'permissions.service.catalog.read.name',
    'permissions.service.catalog.read.description',
    'active'
);
...
JOIN system.permissions permission
  ON permission.permission_key = 'service.catalog.read'
