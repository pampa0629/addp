...
VALUES (
    'model.catalog.read', 'model', 'read', 'low', false,
    ARRAY['tenant']::text[], false,
    'permissions.model.catalog.read.name',
    'permissions.model.catalog.read.description',
    'active'
);
...
JOIN system.permissions permission
  ON permission.permission_key = 'model.catalog.read'
