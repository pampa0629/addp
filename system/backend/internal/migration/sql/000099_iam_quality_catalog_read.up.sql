...
VALUES (
    'quality.catalog.read', 'quality', 'read', 'low', false,
    ARRAY['tenant']::text[], false,
    'permissions.quality.catalog.read.name',
    'permissions.quality.catalog.read.description',
    'active'
);
...
JOIN system.permissions permission
  ON permission.permission_key = 'quality.catalog.read'
