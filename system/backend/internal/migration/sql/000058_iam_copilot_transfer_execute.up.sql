...
INSERT INTO system.permissions (
    ...
    'copilot.transfer.execute', 'copilot', 'execute', 'medium', true,
    ARRAY['tenant', 'department', 'project_group']::text[], true,
    'permissions.copilot.transfer.execute.name',
    'permissions.copilot.transfer.execute.description', 'active'
)
...
JOIN system.permissions AS permission
  ON permission.permission_key = 'copilot.transfer.execute'
