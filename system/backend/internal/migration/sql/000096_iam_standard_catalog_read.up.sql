...
VALUES (
    'standard.catalog.read', 'standard', 'read', 'low', false,
    ARRAY['tenant']::text[], false,
    'permissions.standard.catalog.read.name',
    'permissions.standard.catalog.read.description',
    'active'
);
...
JOIN system.permissions permission
  ON permission.permission_key = 'standard.catalog.read'
