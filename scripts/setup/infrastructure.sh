...
echo ""
echo -e "Next steps:"
echo -e "  1. Compile: ${YELLOW}./scripts/build/compile.sh --arch ${ARCH}${NC}"
echo -e "  2. Build: ${YELLOW}./scripts/build/build-images.sh${NC}"
