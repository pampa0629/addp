...
GO_MODULES=(system manager meta transfer orchestrator develop service monitor standard model quality security portal graph asset inference catalog workbench ontology)
