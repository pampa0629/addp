...
run_without_skips ./internal/repository '^(TestMigrateAgainstPostgres|TestMigrateConvertsLegacyDocumentToStableIdentityAndRevision|TestPostgresDeletePolicies|TestPostgresCodeSetScopeConstraint|TestPostgresElementScopeConstraint|TestPostgresGlossaryScopeConstraint|TestPostgresDocumentRevisionAndExtractionConstraints|TestPostgresMetricRevisionEffectiveIntervals|TestPostgresStandardCollectionGovernanceConstraints|TestPostgresCatalogMetricChangeFeedCapturesOwnerLifecycle|TestPostgresReferenceCandidatesFilterAndPaginateOwnerFacts|TestPostgresDocumentCandidateComparisonTargets|TestPostgresDocumentCandidateFormalization)$'
run_without_skips ./internal/service '^TestPostgres(StandardReferenceDeletion|MetricProfessionalRelations|DocumentCandidateGroups)'
