...
ADDP_MYSQL_INTEGRATION=1 \
    ...
    -run '^TestIntegrationMySQL(AnalyticalRelations|AnalyticalCalendar|AnalyticalExpressions|AnalyticalArithmetic|LosslessAnalyticalInteger|BoundedWatermarkResumeAndIdempotentUpsert|DataProtectionReadContracts)$' \
