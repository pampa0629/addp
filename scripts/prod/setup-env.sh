...
SERVICE_SECRET_KEYS=(
  ...
  SECURITY_SERVICE_CLIENT_SECRET
  POINTCLOUD_WORKFLOW_SERVICE_CLIENT_SECRET
  SERVICE_SERVICE_CLIENT_SECRET
  STANDARD_SERVICE_CLIENT_SECRET
  SPARK_WORKFLOW_SERVICE_CLIENT_SECRET
