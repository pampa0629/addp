...
# Expected policy
SYS_MINIO_API=9002
SYS_MINIO_CONSOLE=9003
BIZ_MINIO_API=9000
BIZ_MINIO_CONSOLE=9001
SYS_PG=5432
BIZ_PG=5433
...
BUSINESS_MINIO_API_PORT=${BUSINESS_MINIO_API_PORT:-9000}
BUSINESS_MINIO_CONSOLE_PORT=${BUSINESS_MINIO_CONSOLE_PORT:-9001}
