...
func TestIntegrationPostgresAnalyticalArithmetic(t *testing.T) {
	...
	conformance.PreparedArithmetic(t, &integerPreparedProvider{PostgreSQLPlugin: provider, compiler: conformance.RelationalFixtureCompiler{Expression: analyticalExpressionDialect{}, Result: analyticalResultDialect{}}}, info)
}
