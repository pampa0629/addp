...
func TestIntegrationMySQLAnalyticalArithmetic(t *testing.T) {
	...
	conformance.PreparedArithmetic(t, &integerPreparedProvider{MySQLPlugin: provider, compiler: conformance.RelationalFixtureCompiler{Expression: analyticalExpressionDialect{}, Result: analyticalResultDialect{}}}, info)
}
