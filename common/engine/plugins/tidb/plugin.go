...
var tidbCatalogFactsDialect = shared.MySQLCompatibleCatalogFactsDialect{
	...
	IncludeComment: true,
	MapFieldType:   tidbCatalogFieldType,
}

func tidbCatalogFieldType(nativeType string) datatype.FieldType {
...
func (p *Plugin) Type() string         { return "tidb" }
func (p *Plugin) DisplayName() string  { return "TiDB" }
...
func (p *Plugin) ConnectionSpec() plugin.ConnectionSpec {
	return plugin.NewConnectionSpec(
		...
		plugin.ConnectionFieldSpec{Key: "port", LabelKey: "storageEngine.port", Input: plugin.ConnectionFieldNumber, Identity: true, Default: 4000, Min: plugin.Int(1), Max: plugin.Int(65535)},
		...
		plugin.ConnectionFieldSpec{Key: "user", LabelKey: "storageEngine.username", Input: plugin.ConnectionFieldText, Required: true, Identity: true, Default: "root", Placeholder: "root"},
		plugin.ConnectionFieldSpec{Key: "password", LabelKey: "storageEngine.password", Input: plugin.ConnectionFieldPassword, Sensitive: true},
	)
}
