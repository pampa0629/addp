...
func (p *MongoDBPlugin) GenerateCapabilities() string {
	return `{"storage":[{"type":"nosql_db","engine":"mongodb","supports_query":true}],"compute":[{"type":"document_query","description":"文档型数据库查询","dev_modes":["javascript"],"features":["flexible_schema","json_native"]}]}`
}
