...
type FormatImplementationSnapshot struct {
	...
	ScopePointCloudInfoProvider bool `json:"scope_point_cloud_info_provider,omitempty"`
...
func implementationSnapshotForFormat(formatType FormatType) FormatImplementationSnapshot {
	...
	_, status.ScopePointCloudInfoProvider = plugin.(ScopePointCloudInfoProvider)
