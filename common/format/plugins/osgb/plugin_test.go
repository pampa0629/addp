...
func TestDescribeModel3DReadsOSGBMetadata(t *testing.T) {
...
func TestDescribeModel3DScopeOpensMetadataXML(t *testing.T) {
	reader := memoryOSGBReader{files: map[string]string{
...
type memoryOSGBReader struct {
	files map[string]string
}

func (r memoryOSGBReader) Open(_ context.Context, ref contentio.Ref) (io.ReadCloser, error) {
...
func (r memoryOSGBReader) Stat(context.Context, contentio.Ref) (*contentio.Stat, error) {
	return nil, contentio.ErrContentNotFound
}
