"""Persistence for Agent-owned Inference Scenario Bindings."""
...
class InferenceScenarioBindingRepository:
    ...
    async def resolve(self, tenant_id: int, scenario_code: str) -> InferenceScenarioBinding | None:
    ...
    async def save(
        ...
        *,
        ...
        current = await self._db.scalar(statement)
        if current is None:
