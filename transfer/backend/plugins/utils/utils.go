...
// MapToStruct 将 map 转换为结构体（导出供子包使用）
...
// GetStringConfig 从配置中获取字符串值（导出供子包使用）
...
// GetIntConfig 从配置中获取整数值（导出供子包使用）
...
// GetBoolConfig 从配置中获取布尔值（导出供子包使用）
...
// GetStringSliceConfig 从配置中获取字符串数组（导出供子包使用）
