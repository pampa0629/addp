...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/executions": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "一次性同步执行 | One-off sync execution",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_transfer_internal_models.CreateAdHocExecutionRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_transfer_internal_models.CreateAdHocExecutionResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "github_com_addp_transfer_internal_models.CreateAdHocExecutionRequest": {
            "type": "object",
            "required": [
                "config",
                "name"
        ...
        "github_com_addp_transfer_internal_models.CreateAdHocExecutionResponse": {
            "type": "object",
            "properties": {
                "execution_id": {
                    "type": "string"
        ...
        "github_com_addp_transfer_internal_models.TransferQueryInputDoc": {
            "type": "object",
            "properties": {
                "locator": {
                    "type": "string",
                    "example": "addp://engine/9/path/public/orders?type=table\u0026item_id=42"
                },
                "name": {
                    "type": "string",
                    "example": "orders"
        ...
        "github_com_addp_transfer_internal_models.TransferQuerySourceDoc": {
            ...
            "properties": {
                "inputs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_transfer_internal_models.TransferQueryInputDoc"
                    }
                },
                "language": {
                    "type": "string",
