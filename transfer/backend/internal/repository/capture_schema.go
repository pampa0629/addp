	...
	return db.Transaction(func(tx *gorm.DB) error {
		statements := []string{
			...
			fmt.Sprintf(`CREATE TABLE IF NOT EXISTS %s (
				...
				schema_history_topic_name VARCHAR(255) NOT NULL,
				schema_history_topic_owned BOOLEAN NOT NULL DEFAULT TRUE,
				spatial_mirror_table_name VARCHAR(30) NOT NULL DEFAULT '',
				spatial_row_trigger_name VARCHAR(30) NOT NULL DEFAULT '',
				spatial_ddl_guard_name VARCHAR(30) NOT NULL DEFAULT '',
			...
			fmt.Sprintf(`ALTER TABLE %s ADD COLUMN IF NOT EXISTS spatial_mirror_table_name VARCHAR(30) NOT NULL DEFAULT ''`, oracleResources),
			fmt.Sprintf(`ALTER TABLE %s ADD COLUMN IF NOT EXISTS spatial_row_trigger_name VARCHAR(30) NOT NULL DEFAULT ''`, oracleResources),
			fmt.Sprintf(`ALTER TABLE %s ADD COLUMN IF NOT EXISTS spatial_ddl_guard_name VARCHAR(30) NOT NULL DEFAULT ''`, oracleResources),
			fmt.Sprintf(`ALTER TABLE %s ADD COLUMN IF NOT EXISTS spatial_artifacts_owned BOOLEAN NOT NULL DEFAULT FALSE`, oracleResources),
			fmt.Sprintf(`ALTER TABLE %s DROP COLUMN IF EXISTS spatial_trigger_name`, oracleResources),
