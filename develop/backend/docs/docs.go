...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_develop_backend_internal_models.ExecutionWithDevTask"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_develop_backend_internal_models.ListProviderDevTasksResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_develop_backend_internal_models.ProviderDevTask"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "github_com_addp_develop_backend_internal_models.ExecutionWithDevTask": {
            "type": "object",
            "properties": {
                "bytes_read": {
        ...
        "github_com_addp_develop_backend_internal_models.ListProviderDevTasksResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "github_com_addp_develop_backend_internal_models.ProviderDevTask": {
            "type": "object",
            "properties": {
                "content": {
                    "$ref": "#/definitions/github_com_addp_develop_backend_internal_models.DevTaskContent"
