...
const (
	...
	MsgQueryExportInvalid                     = "develop.query.export_invalid"
	MsgQueryExportNotFound                    = "develop.query.export_not_found"
	MsgQueryExportUnavailable                 = "develop.query.export_unavailable"
	...
	MsgNotebookEngineCatalogRequestInvalid    = "develop.notebook.engine_catalog_request_invalid"
	MsgNotebookEngineCatalogForbidden         = "develop.notebook.engine_catalog_forbidden"
	MsgNotebookSessionControlPlaneFailed      = "develop.notebook.engine_catalog_control_plane_failed"
	MsgNotebookEngineCatalogProviderFailed    = "develop.notebook.engine_catalog_provider_failed"
	MsgNotebookEngineCatalogEngineNotFound    = "develop.notebook.engine_catalog_engine_not_found"
	MsgNotebookEngineCatalogEntryNotFound     = "develop.notebook.engine_catalog_entry_not_found"
	MsgNotebookEngineCatalogUnsupported       = "develop.notebook.engine_catalog_unsupported"
	MsgNotebookEngineCatalogEngineUnavailable = "develop.notebook.engine_catalog_engine_unavailable"
	MsgNotebookEngineCatalogTimeout           = "develop.notebook.engine_catalog_timeout"
