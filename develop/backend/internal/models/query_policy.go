...
type QueryPolicy struct {
	...
	QueryConcurrency          int       `gorm:"not null;default:20" json:"query_concurrency"`
	QueryPerEngineConcurrency int       `gorm:"not null;default:5" json:"query_per_engine_concurrency"`
