...
const docTemplate = `{
        ...
        "/query/{id}/execution-query": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "当前测试条件 | Current test request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_service_internal_models.ExecutionQueryPreview"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_addp_service_internal_models.ExecutionQueryParameter": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "github_com_addp_service_internal_models.ExecutionQueryPreview": {
            "type": "object",
            "properties": {
                "engine_id": {
                    "type": "integer"
                ...
                "parameters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_service_internal_models.ExecutionQueryParameter"
                    }
                },
                "query": {
                    "type": "string"
