...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_orchestrator_internal_models.ListProviderOrchestrationTasksResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "github_com_addp_orchestrator_internal_models.ListProviderOrchestrationTasksResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
