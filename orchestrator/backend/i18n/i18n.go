...
const (
	...
	MsgOutputBindingInvalidFormat             = "orchestrator.error.output_binding_invalid_format"
	MsgOutputBindingUnknownStep               = "orchestrator.error.output_binding_unknown_step"
	MsgOutputBindingUndeclared                = "orchestrator.error.output_binding_undeclared"
	MsgOutputBindingUnknownTarget             = "orchestrator.error.output_binding_unknown_target"
	MsgOutputBindingTypeMismatch              = "orchestrator.error.output_binding_type_mismatch"
