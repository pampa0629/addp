...
type DataValidationTask struct {
	...
	TenantID            int64           `gorm:"not null;uniqueIndex:uq_quality_data_validation_code" json:"tenant_id"`
	Code                string          `gorm:"size:100;not null;uniqueIndex:uq_quality_data_validation_code" json:"code"`
...
func (DataValidationTask) TableName() string {
	return "quality.data_validation_tasks"
}
