...
async function submit(){loading.value=true;try{await auth.login(username.value,password.value);router.push('/sensitive-data-types')}catch(e){ElMessage.error(e.message||t('security.common.failed'))}finally{loading.value=false}}
</script>
