...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.CreateProtectionExemptionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/protection-exemptions/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "豁免 ID | Exemption ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "续期请求 | Renewal request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.RenewProtectionExemptionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_api.CreateProtectionExemptionRequest": {
            "type": "object",
            "required": [
                "action",
                "assessment_id",
        ...
        "internal_api.RenewProtectionExemptionRequest": {
            "type": "object",
            "required": [
                "expires_at",
                "rationale",
