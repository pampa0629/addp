...
func migrateSQLite(db *gorm.DB) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS security.sensitive_data_types (id INTEGER PRIMARY KEY AUTOINCREMENT, tenant_id INTEGER NOT NULL, code TEXT NOT NULL, name TEXT NOT NULL, description TEXT, security_classification_id INTEGER NOT NULL, default_security_grade_id INTEGER NOT NULL, protection_threshold REAL NOT NULL DEFAULT 0.8, version INTEGER NOT NULL DEFAULT 1, created_by INTEGER NOT NULL, updated_by INTEGER, created_at DATETIME, updated_at DATETIME, UNIQUE (tenant_id, code))`,
		...
		`CREATE TABLE IF NOT EXISTS security.protection_enrollments (id TEXT PRIMARY KEY, tenant_id INTEGER NOT NULL, target_owner TEXT NOT NULL, target_type TEXT NOT NULL, target_identity TEXT NOT NULL, target_engine_id INTEGER NOT NULL, target_item_type TEXT NOT NULL, target_full_name TEXT NOT NULL, state TEXT NOT NULL, version INTEGER NOT NULL DEFAULT 1, release_reason TEXT NOT NULL DEFAULT '', release_basis TEXT NOT NULL DEFAULT '', release_requested_by INTEGER, release_requested_at DATETIME, release_source_snapshot_hash TEXT NOT NULL DEFAULT '', latest_source_snapshot_hash TEXT NOT NULL DEFAULT '', last_discovered_at DATETIME, created_by INTEGER NOT NULL, released_at DATETIME, created_at DATETIME, updated_at DATETIME)`,
		...
		`CREATE TABLE IF NOT EXISTS security.sensitive_findings (id TEXT PRIMARY KEY, tenant_id INTEGER NOT NULL, enrollment_id TEXT NOT NULL, component_key TEXT NOT NULL, sensitive_data_type_id INTEGER NOT NULL, detector_code TEXT NOT NULL, detector_version TEXT NOT NULL, confidence REAL NOT NULL, evidence TEXT NOT NULL, component TEXT NOT NULL, source_snapshot_hash TEXT NOT NULL, observed_at DATETIME NOT NULL, created_at DATETIME NOT NULL, UNIQUE (tenant_id, enrollment_id, component_key, detector_version, source_snapshot_hash))`,
		...
		`CREATE TABLE IF NOT EXISTS security.resource_security_assessment_revisions (id TEXT PRIMARY KEY, tenant_id INTEGER NOT NULL, assessment_id TEXT NOT NULL, revision INTEGER NOT NULL, source_finding_id TEXT NOT NULL, source_review_id TEXT NOT NULL, sensitive_data_type_id INTEGER NOT NULL, security_classification_id INTEGER NOT NULL, security_grade_id INTEGER NOT NULL, source_snapshot_hash TEXT NOT NULL, component TEXT NOT NULL, rationale TEXT NOT NULL, created_by INTEGER NOT NULL, created_at DATETIME NOT NULL, UNIQUE (assessment_id, revision))`,
