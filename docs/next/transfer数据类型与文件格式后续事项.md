...
3. 需要继续补齐 common 中缺失的高性能 table reader / writer、resource writer、stream / CDC 抽象；`common/format` 已有 CSV / TSV 最小 `TableWriterProvider`，其他格式按 data type 命名继续由具体 format plugin 实现。
