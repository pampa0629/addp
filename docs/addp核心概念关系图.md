...
### 11. [认证与路由](concepts/addp认证与路由体系图.md)

**JWT 认证流程、Gateway 路由机制和 Portal 架构**

- JWT 认证流程 (登录阶段、访问资源阶段)
- Gateway 路由机制 (路由规则、请求转发)
- Portal 架构 (统一门户模式、独立模块模式)
- Backend/Worker 分离架构

📄 **[阅读完整文档 →](concepts/addp认证与路由体系图.md)**
...
- **[认证与路由体系图](concepts/addp认证与路由体系图.md)** - JWT 认证流程、Gateway 路由、Portal 架构
...
- [ADDP 核心概念说明(详版)](addp核心概念说明（详版）.md) - 完整的文字说明版本
