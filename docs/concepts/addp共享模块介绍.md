...
- 通用数据类型、格式能力、provider / reader 和资源读取抽象可以放入 common，但 data item 识别、claims / exclusive、`meta_item.full_name` 决策和 attributes 落库构造属于 Meta 模块；详细边界见 [数据项体系图](addp数据项体系图.md)
