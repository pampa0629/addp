...
环境变量：
  ADDP_TENANT_ID: 租户 ID（必需）
  ADDP_API_BASE: ADDP API 基础 URL（默认：http://host.docker.internal:8085）
...
ADDP_TENANT_ID = os.getenv('ADDP_TENANT_ID')
ADDP_API_BASE = os.getenv('ADDP_API_BASE', 'http://host.docker.internal:8085')
