...
Spark Sedona Engine 是 ADDP 平台的分布式空间计算引擎,基于 Apache Spark 和 Apache Sedona (原 GeoSpark) 构建,支持大规模空间数据处理和分析。
...
## 与 GeoPandas Engine 的对比

| 特性 | GeoPandas Engine | Spark Sedona Engine |
|------|------------------|---------------------|
...
- [GeoPandas Engine 对比](../geopandas/README.md)
