...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/data_applications": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "数据应用名称和完整草稿 | Data application name and complete draft",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "github_com_addp_workbench_internal_models.ComponentParameterFilter": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "github_com_addp_workbench_internal_models.ComponentQueryTemplate": {
            "type": "object",
            "properties": {
                "fixed_filter": {
                ...
                "parameter_filters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_workbench_internal_models.ComponentParameterFilter"
                    }
                },
                "select": {
                    "type": "array",
        ...
        "github_com_addp_workbench_internal_models.DataApplicationComponent": {
            ...
            "properties": {
                ...
                "parameter_definitions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_workbench_internal_models.ComponentParameterDefinition"
                    }
                },
                "query_template": {
                    "$ref": "#/definitions/github_com_addp_workbench_internal_models.ComponentQueryTemplate"
                },
                "renderer_config": {
                    "type": "object"
                },
