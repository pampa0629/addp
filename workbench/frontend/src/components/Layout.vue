<template>
  ...
  <el-container v-else class="layout">
    ...
    <el-container class="main"><el-aside width="220px" class="sidebar"><el-menu router :default-active="active"><el-menu-item index="/applications"><el-icon><Grid /></el-icon><span>{{ t('workbench.dataApplications') }}</span></el-menu-item></el-menu></el-aside><el-main class="content"><router-view /></el-main></el-container>
  </el-container>
</template>
<script setup>
...
const active = computed(() => route.path.startsWith('/applications') ? '/applications' : route.path)
