<template>
  ...
  <el-container v-else class="layout">
    ...
    <el-container class="main"><el-aside width="220px" class="sidebar"><el-menu router :default-active="active"><el-menu-item index="/views"><el-icon><View /></el-icon><span>{{ t('workbench.views') }}</span></el-menu-item></el-menu></el-aside><el-main class="content"><router-view /></el-main></el-container>
  </el-container>
</template>
<script setup>
...
const active = computed(() => route.path.startsWith('/views') ? '/views' : route.path)
