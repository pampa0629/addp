...
func FileSingleInput(
	...
	return input{
		...
		ConnInfo:             connInfo,
		EngineCatalogPath:    file.EngineCatalogPath,
		EngineCatalogPathFor: func(string) plugin.EngineCatalogPath { return file.EngineCatalogPath },
...
func FileDetectedInput(
	...
	tenantID uint,
	parentNode *models.MetaNode,
	itemPlan scanresource.FileDetectedItemPlan,
	detected *metaitem.DetectedItem,
	contentReader plugin.ContentReadableProvider,
	connInfo plugin.ConnectionInfo,
	scanDepth string,
	...
	return input{
		...
		ContentReader:        contentReader,
		ConnInfo:             connInfo,
		EngineCatalogPathFor: plugin.FileItemPathForEngine(resource.ID),
...
func ObjectSingleInput(
	...
	parentNode *models.MetaNode,
	itemPlan scanresource.ObjectSingleItemPlan,
	...
	return input{
		...
		ContentReader:        contentReader,
		ConnInfo:             connInfo,
		EngineCatalogPath:    catalogResource.EngineCatalogPath,
		EngineCatalogPathFor: func(string) plugin.EngineCatalogPath { return catalogResource.EngineCatalogPath },
...
func ObjectCompositeInput(
	...
	tenantID, engineID uint,
	parentNode *models.MetaNode,
	itemPlan scanresource.ObjectCompositeItemPlan,
	...
	return input{
		...
		PhysicalPath:         itemPlan.FullName,
...
func KnownItemInput(
	...
	return input{
		...
		ContentReader:        contentReader,
		ConnInfo:             connInfo,
		EngineCatalogPathFor: catalogPathFor,
