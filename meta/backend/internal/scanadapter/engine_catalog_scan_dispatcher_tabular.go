...
func (d *EngineCatalogScanDispatcher) dispatchTabularScan(ctx context.Context, enginePlugin plugin.EnginePlugin, plan scanflow.EngineCatalogScanPlan, req scanflow.DispatchRequest) (scanflow.DispatchResult, error) {
	...
	if fullEngineScan {
		...
		rootBranchEntries, err := scanresource.RootBranchEntries(ctx, req.Resource, enginePlugin)
		if err != nil {
...
func (d *EngineCatalogScanDispatcher) scanResourceNamespaces(
	ctx context.Context,
