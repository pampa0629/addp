...
func TestObjectStorageResourceFromNodeDoesNotUseUnknownExtensionAsFormat(t *testing.T) {
	...
	resource := ObjectStorageResourceFromNode("addp", plugin.EngineCatalogEntry{
		...
		Path: plugin.EngineCatalogPath{
			...
			Segments: []plugin.EngineCatalogSegment{
				{Term: plugin.EngineCatalogTermBucket, Kind: plugin.EngineCatalogKindBucket, Name: "addp"},
				{Term: plugin.EngineCatalogTermPrefix, Kind: plugin.EngineCatalogKindPrefix, Name: "raw"},
				{Term: plugin.EngineCatalogTermObject, Kind: plugin.EngineCatalogKindObject, Name: "docker-compose.yml"},
			},
		},
	...
	resource := ObjectStorageResourceFromNode("addp", plugin.EngineCatalogEntry{
		...
		Path: plugin.EngineCatalogPath{
			...
			Segments: []plugin.EngineCatalogSegment{
				{Term: plugin.EngineCatalogTermBucket, Kind: plugin.EngineCatalogKindBucket, Name: "addp"},
				{Term: plugin.EngineCatalogTermPrefix, Kind: plugin.EngineCatalogKindPrefix, Name: "raw"},
				{Term: plugin.EngineCatalogTermObject, Kind: plugin.EngineCatalogKindObject, Name: "yanshi.addpunknownfmt"},
			},
		},
		Storage: &plugin.EngineCatalogStorageFacts{
...
func TestObjectStorageResourceFromNodeUsesKnownMIMEWhenExtensionUnknown(t *testing.T) {
	...
	resource := ObjectStorageResourceFromNode("addp", plugin.EngineCatalogEntry{
		...
		Path: plugin.EngineCatalogPath{
			...
			Segments: []plugin.EngineCatalogSegment{
				{Term: plugin.EngineCatalogTermBucket, Kind: plugin.EngineCatalogKindBucket, Name: "addp"},
				{Term: plugin.EngineCatalogTermObject, Kind: plugin.EngineCatalogKindObject, Name: "config"},
			},
		},
		Storage: &plugin.EngineCatalogStorageFacts{
			Path:        "config",
...
func TestStorageFileRefFromEntryProjectsCatalogEntrySummary(t *testing.T) {
	...
	entry, ok := StorageFileRefFromEntry(plugin.EngineCatalogEntry{
		Name: "roads.csv",
...
func TestStorageFileRefFromEntryIgnoresSystemFiles(t *testing.T) {
	...
	sizeBytes := int64(1)
	_, ok := StorageFileRefFromEntry(plugin.EngineCatalogEntry{
		Name: ".DS_Store",
...
func TestStorageDirectoryRefFromEntryFallsBackToCatalogPath(t *testing.T) {
	...
	entry, ok := StorageDirectoryRefFromEntry(plugin.EngineCatalogEntry{
		Name: "datasets",
...
func TestStorageDirectoryRefFromEntryIgnoresSystemDirectories(t *testing.T) {
	...
	_, ok := StorageDirectoryRefFromEntry(plugin.EngineCatalogEntry{
		Name: "__MACOSX",
...
func TestObjectCatalogCompositeNameUsesSingleFilePrimaryContentPath(t *testing.T) {
	...
	name, objectPath := ObjectCompositeName(ObjectCompositeItem{
		Bucket: "addp",
		Prefix: "lake",
...
func TestPlanObjectCatalogSingleItemBuildsIdentityAndAttributes(t *testing.T) {
	...
	plan := PlanObjectSingleItem(7, StorageResource{
		RootName:     "addp",
...
func TestPlanObjectCatalogCompositeItemBuildsStandardAttributes(t *testing.T) {
	...
	plan, ok := PlanObjectCompositeItem(7, ObjectCompositeItem{
		Bucket: "addp",
