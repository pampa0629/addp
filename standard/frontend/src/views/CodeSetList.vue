<template>
  <div class="page-shell">
    ...
    <el-card shadow="never" class="filter-card"><el-row :gutter="12"><el-col :span="7"><el-input v-model="filters.keyword" :prefix-icon="Search" clearable :placeholder="$t('standard.codeSet.searchPlaceholder')" @change="search" /></el-col><el-col :span="5"><el-select v-model="filters.scope_type" clearable :placeholder="$t('standard.common.selectScope')" style="width:100%" @change="search"><el-option v-for="scope in scopeOptions" :key="scope" :label="scopeLabel(scope)" :value="scope" /></el-select></el-col><el-col :span="6"><BusinessDomainSelect v-model="filters.owner_domain_id" clearable :placeholder="$t('standard.common.selectDomain')" style="width:100%" @change="search" :options="domains" /></el-col><el-col :span="5"><el-select v-model="filters.status" clearable :placeholder="$t('standard.common.selectStatus')" style="width:100%" @change="search"><el-option v-for="s in statuses" :key="s" :value="s" :label="statusLabel(s)" /></el-select></el-col></el-row></el-card>
    ...
    <el-dialog v-model="dialog" :title="$t('standard.codeSet.createTitle')" width="600px"><el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
      <el-form-item :label="$t('standard.codeSet.codeLabel')" prop="code"><el-input v-model="form.code" :placeholder="$t('standard.common.codePlaceholder')" /></el-form-item><el-form-item :label="$t('standard.codeSet.nameLabel')" prop="name"><el-input v-model="form.name" /></el-form-item><el-form-item :label="$t('standard.common.scopeLabel')" prop="scope_type"><el-select v-model="form.scope_type" style="width:100%"><el-option v-for="scope in editableScopes" :key="scope" :label="scopeLabel(scope)" :value="scope" /></el-select></el-form-item><el-form-item v-if="requiresOwnerDomain(form.scope_type)" :label="$t('standard.common.ownerDomainLabel')" prop="owner_domain_id"><BusinessDomainSelect v-model="form.owner_domain_id" style="width:100%" :options="domains" /></el-form-item><el-form-item :label="$t('standard.codeSet.valueType')" prop="value_type"><el-select v-model="form.value_type" style="width:100%"><el-option value="string" /><el-option value="int" /><el-option value="bigint" /></el-select></el-form-item><el-form-item :label="$t('standard.codeSet.descriptionLabel')" prop="description"><el-input v-model="form.description" type="textarea" /></el-form-item>
