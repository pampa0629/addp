...
const candidateGroupResponse = reactive({ data: [], total: 0, page: 1, page_size: 20, total_pages: 1, status_counts: { pending: 0, retained: 0, rejected: 0, formalized: 0 }, comparison_counts: { new: 0, exact: 0, content_conflict: 0, scope_conflict: 0 } })
...
const comparisonCount = result => candidateGroupResponse.comparison_counts?.[result] || 0
const comparisonFacetTotal = computed(() => comparisonResults.reduce((total, result) => total + comparisonCount(result), 0))
