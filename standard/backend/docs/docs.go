...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/documents/{id}/extraction-candidate-groups": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_standard_internal_models.PaginatedDocumentExtractionCandidateGroupResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateGroupComparisonCounts": {
            "type": "object",
            "properties": {
                "content_conflict": {
                    "type": "integer"
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateGroupStatusCounts": {
            "type": "object",
            "properties": {
                "formalized": {
                    "type": "integer"
        ...
        "github_com_addp_standard_internal_models.PaginatedDocumentExtractionCandidateGroupResponse": {
            "type": "object",
            "properties": {
                "comparison_counts": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateGroupComparisonCounts"
                },
                "data": {
                    "type": "array",
                    "items": {
                ...
                "status_counts": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateGroupStatusCounts"
                },
                "total": {
                    "type": "integer"
                },
