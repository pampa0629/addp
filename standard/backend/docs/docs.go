...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/document-extraction-candidates/{candidate_id}/formalization": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "候选 ID | Candidate ID",
                        "name": "candidate_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "正式化请求 | Formalization request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_standard_internal_models.FormalizeDocumentExtractionCandidateRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentCandidateFormalizationResponse"
                        }
                    },
                    "400": {
        ...
        "/documents/{id}/extraction-candidate-families": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "代表候选编码或名称关键词，忽略大小写并规范化空白 | Representative candidate code or name keyword, case-insensitive with normalized whitespace",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
                        ...
                        "type": "string",
                        "description": "与当前标准的实时比对结果 | Live comparison result against current standards",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_standard_internal_models.PaginatedDocumentExtractionCandidateFamilyResponse"
                        }
                    },
                    "400": {
        ...
        "/documents/{id}/extraction-candidates/batch_decide": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "候选族快照令牌、胜出候选及 1–1000 字符人工理由 | Family snapshot token, winner, and a 1–1000 character human reason",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "理由、快照令牌格式或胜出候选无效，error_code=candidate_family_decision_invalid | Invalid reason, snapshot token format, or winner; error_code=candidate_family_decision_invalid",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "409": {
                        "description": "快照令牌过期返回 error_code=candidate_family_snapshot_stale；或候选已正式化 | Stale snapshot token returns error_code=candidate_family_snapshot_stale; or a candidate is already formalized",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/documents/{id}/revisions/{revision_id}/extractions": {
            "post": {
                ...
                "responses": {
                    ...
                    "422": {
                        "description": "文档格式、提炼结果或业务域编码命名空间无效 | Invalid document format, extraction result, or domain code namespace",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/elements/{id}/revisions/{revision_id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "精确修订 ID | Exact revision ID",
                        "name": "revision_id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_standard_internal_service.ElementRevisionDetail"
                        }
                    }
                },
                "x-addp-auth-mode": "permission",
    ...
    "definitions": {
        ...
        "github_com_addp_standard_internal_models.DocumentCandidateFormalization": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string",
        ...
        "github_com_addp_standard_internal_models.DocumentCandidateFormalizationResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string",
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidate": {
            ...
            "properties": {
                ...
                "formalization": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentCandidateFormalization"
                },
                "id": {
                    "type": "integer"
                },
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateFamily": {
            "type": "object",
            "properties": {
                "candidate_type": {
                    "type": "string",
                ...
                "variants": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateGroup"
                    }
                }
            }
        },
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateFamilyComparisonCounts": {
            "type": "object",
            "properties": {
                "all": {
                    "type": "integer"
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateGroup": {
            "type": "object",
            "properties": {
                "candidate": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidate"
                ...
                "occurrences": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateOccurrence"
                    }
                },
                "semantic_fingerprint": {
                    "type": "string"
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateOccurrence": {
            "type": "object",
            "properties": {
                "candidate_id": {
                    "type": "integer"
        ...
        "github_com_addp_standard_internal_models.DocumentExtractionCandidateVariantStatusCounts": {
            "type": "object",
            "properties": {
                "formalized": {
                    "type": "integer"
        ...
        "github_com_addp_standard_internal_models.FormalizeDocumentExtractionCandidateRequest": {
            "type": "object",
            "required": [
                "change_summary",
                "version"
        ...
        "github_com_addp_standard_internal_models.PaginatedDocumentExtractionCandidateFamilyResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateFamily"
                    }
                },
                "family_comparison_counts": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateFamilyComparisonCounts"
                },
                "page": {
                    "type": "integer"
                },
                ...
                "variant_status_counts": {
                    "$ref": "#/definitions/github_com_addp_standard_internal_models.DocumentExtractionCandidateVariantStatusCounts"
                },
                "variant_total": {
                    "type": "integer"
                }
        ...
        "github_com_addp_standard_internal_service.ElementRevisionDetail": {
            "type": "object",
            "properties": {
                "change_summary": {
                    "type": "string"
        ...
        "github_com_addp_standard_internal_service.ReferenceCandidate": {
            ...
            "properties": {
                ...
                "domain_path": {
                    "description": "业务域完整名称路径 / Full domain name path.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
