...
// @Description 首次创建说明由服务端按请求语言生成，请求不包含 change_summary。 | Initial creation summary is generated by the server in the request language; change_summary is not accepted.
// @Tags Standard
// @Accept json
// @Produce json
...
func (h *MetricHandler) CreateMetric(c *gin.Context) {
	...
	item, err := h.svc.CreateMetric(&req, getTenantID(c), getUserID(c), commoni18n.T(c, sysi18n.MsgRevisionInitialCreation))
	if err != nil {
		respondError(c, http.StatusBadRequest, err)
		return
	}
