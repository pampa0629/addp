...
func (h *DocumentHandler) CreateDocument(c *gin.Context) {
	...
	tenantID := getTenantID(c)
	userID := getUserID(c)
	doc, err := h.svc.CreateDocument(&req, tenantID, userID, commoni18n.T(c, sysi18n.MsgRevisionInitialCreation))
	if err != nil {
		respondError(c, http.StatusBadRequest, err)
		return
	}
...
func (h *DocumentHandler) CreateAndLinkElement(c *gin.Context) {
	...
	doc, err := h.svc.CreateAndLinkElement(&req, getTenantID(c), getUserID(c), entityID, commoni18n.T(c, sysi18n.MsgRevisionInitialCreation))
	if err != nil {
		respondError(c, http.StatusBadRequest, err)
		return
	}
...
func (h *DocumentHandler) CreateAndLinkGlossary(c *gin.Context) {
	...
	doc, err := h.svc.CreateAndLinkGlossary(&req, getTenantID(c), getUserID(c), entityID, commoni18n.T(c, sysi18n.MsgRevisionInitialCreation))
	if err != nil {
		respondError(c, http.StatusBadRequest, err)
		return
	}
...
func (h *DocumentHandler) CreateAndLinkMetric(c *gin.Context) {
	...
	doc, err := h.svc.CreateAndLinkMetric(&req, getTenantID(c), getUserID(c), entityID, commoni18n.T(c, sysi18n.MsgRevisionInitialCreation))
	if err != nil {
		respondError(c, http.StatusBadRequest, err)
		return
	}
