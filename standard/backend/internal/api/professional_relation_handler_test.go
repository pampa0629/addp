...
func TestMetricProfessionalRelationRouteUsesCurrentUserPermissionAndTenant(t *testing.T) {
	...
	router := SetupRouter(db, nil, nil, nil, nil, nil, metricService, nil, nil, nil, nil, authServer.URL, modulelifecycle.NewStandalone("standard"))
