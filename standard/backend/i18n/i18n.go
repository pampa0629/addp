...
const (
	...
	MsgInvalidStandardCollection              = "standard.collection.invalid"
	MsgStandardCollectionAccessDenied         = "standard.collection.access_denied"
	MsgStandardCollectionReviewerRequired     = "standard.collection.reviewer_required"
	MsgStandardCollectionOwnerRequired        = "standard.collection.owner_required"
	MsgStandardCollectionSelfApproval         = "standard.collection.self_approval"
	MsgStandardGovernanceDirectoryUnavailable = "standard.collection.directory_unavailable"
