...
func assetPermissionRouteContracts() []permissionRouteContract {
	return []permissionRouteContract{
		...
		{http.MethodGet, "/api/v1/asset/categories", "", managementPermissions(authorization.PermissionAssetCategoryRead)},
		{http.MethodGet, "/api/v1/asset/categories/tree", "", managementPermissions(authorization.PermissionAssetCategoryRead)},
		{http.MethodGet, "/api/v1/asset/categories/invalid", "", managementPermissions(authorization.PermissionAssetCategoryRead)},
		{http.MethodPost, "/api/v1/asset/categories", `{}`, managementPermissions(authorization.PermissionAssetCategoryCreate)},
		{http.MethodPut, "/api/v1/asset/categories/invalid", `{}`, managementPermissions(authorization.PermissionAssetCategoryUpdate)},
		...
		{http.MethodPost, "/api/v1/asset/assets/batch-category", `{}`, managementPermissions(authorization.PermissionAssetEntryUpdate)},
		...
		{http.MethodGet, "/api/v1/asset/consumer/categories", "", []string{authorization.PermissionAssetCategoryRead}},
