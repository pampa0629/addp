	...
	builtinTypes := []models.TypeDefinition{
		{
			...
			AuthHandler:   "soft",
			EntryType:     "preview",
			DiscoveryPath: "/api/meta/assets/discoverable",
		...
		},
		{
			...
			AuthHandler:   "token",
			EntryType:     "token",
			DiscoveryPath: "/api/service/internal/assets/discoverable",
		...
		},
		{
			...
			AuthHandler:   "soft",
			EntryType:     "preview",
			DiscoveryPath: "/api/standard/internal/assets/discoverable",
		...
		},
		{
			...
			AuthHandler:   "soft",
			EntryType:     "link",
			DiscoveryPath: "/api/develop/internal/assets/discoverable",
