...
const (
	...
	MsgDimensionTableRequired          = "model.dimension_hierarchy.dimension_table_required"
	MsgDimensionHierarchyNotFound      = "model.dimension_hierarchy.not_found"
	MsgDimensionHierarchyConflict      = "model.dimension_hierarchy.conflict"
	MsgDimensionHierarchyFieldNotFound = "model.dimension_hierarchy.field_not_found"
	MsgDimensionHierarchyLevelNotFound = "model.dimension_hierarchy.level_not_found"
	...
	MsgMaterializedTargetConflict    = "model.materialized_target.conflict"
	MsgMaterializedTargetForbidden   = "model.materialized_target.forbidden"
	MsgMaterializedTargetUnavailable = "model.materialized_target.unavailable"
