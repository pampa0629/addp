...
func TestModelRoutesEnforcePermissions(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "metric implementation list", method: http.MethodGet, path: "/api/v1/model/logical-tables/invalid/metric-implementations", permissions: []string{"model.logical_model.read"}, testAllowed: true},
		{name: "metric implementation create", method: http.MethodPost, path: "/api/v1/model/logical-tables/1/metric-implementations", permissions: []string{"model.logical_model.update"}, testAllowed: true},
		{name: "metric implementation update", method: http.MethodPut, path: "/api/v1/model/logical-tables/1/metric-implementations/1", permissions: []string{"model.logical_model.update"}, testAllowed: true},
		{name: "metric implementation delete", method: http.MethodDelete, path: "/api/v1/model/logical-tables/1/metric-implementations/1", permissions: []string{"model.logical_model.update"}, testAllowed: true},
