...
func TestModelRoutesEnforcePermissions(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "mermaid import preview", method: http.MethodPost, path: "/api/v1/model/entities/import-mermaid/preview", permissions: []string{"model.entity.create", "model.entity_relation.create"}, testAllowed: true},
		{name: "mermaid import", method: http.MethodPost, path: "/api/v1/model/entities/import-mermaid", permissions: []string{"model.entity.create", "model.entity_relation.create"}, testAllowed: true},
		...
		{name: "metric implementation list", method: http.MethodGet, path: "/api/v1/model/metric-implementations/invalid", permissions: []string{"model.metric_implementation.read"}, testAllowed: true},
		{name: "metric implementation create", method: http.MethodPost, path: "/api/v1/model/metric-implementations", permissions: []string{"model.metric_implementation.create"}, testAllowed: true},
		{name: "metric implementation update", method: http.MethodPut, path: "/api/v1/model/metric-implementations/1/draft", permissions: []string{"model.metric_implementation.update"}, testAllowed: true},
		{name: "metric implementation delete", method: http.MethodDelete, path: "/api/v1/model/metric-implementations/invalid", permissions: []string{"model.metric_implementation.delete"}, testAllowed: true},
