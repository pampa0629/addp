...
func TestProfessionalRelationsExposeOwnerFactsWithoutCatalogCopies(t *testing.T) {
	...
	for _, statement := range []string{
		...
		`CREATE TABLE model.logical_fields (id INTEGER PRIMARY KEY, table_id INTEGER NOT NULL, name TEXT)`,
		...
		`INSERT INTO model.logical_fields VALUES (31, 21, 'customer_id'), (32, 22, 'id')`,
