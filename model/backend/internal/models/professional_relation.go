...
type ProfessionalRelationComponent struct {
	ResourceID string `json:"resource_id"`
	Name       string `json:"name,omitempty"`
}
...
type ProfessionalRelationEdge struct {
	...
	SourceComponent *ProfessionalRelationComponent `json:"source_component,omitempty"`
	TargetComponent *ProfessionalRelationComponent `json:"target_component,omitempty"`
