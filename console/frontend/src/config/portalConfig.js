...
export const PAGE_MAPS = {
  manager: {
    ...
    'gaussian-splat-quick-view': 'gaussian-splat-quick-view',
    ...
    items: [
      ...
      { index: '/manager/vectorization-tasks', icon: List,     label: 'console.menus.manager.vectorizationTasks' },
      {
        ...
        children: [
          ...
          { index: '/manager/gaussian-splat-quick-view',              icon: Odometer,    label: 'console.menus.manager.gaussianSplatQuickView' },
