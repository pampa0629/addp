...
export const PAGE_MAPS = {
  manager: {
    ...
    'spatial-quick-view/cad-preview': 'spatial-quick-view/cad-preview',
    'model-3d-glb': 'model-3d-glb',
    'model-3d-tiles': 'model-3d-tiles',
    'gaussian-splat-ksplat': 'gaussian-splat-ksplat',
    'point-cloud-copc': 'point-cloud-copc',
    '': 'data-explorer',
  },
  meta: {
    'scan': 'scan',
  ...
  manager: {
    ...
    items: [
      ...
      { index: '/manager/vectorization-tasks', icon: List,     label: 'console.menus.manager.vectorizationTasks' },
      {
        ...
        children: [
          { index: '/manager/spatial-quick-view/vector-materialized-view', icon: TrendCharts, label: 'console.menus.manager.vectorMaterializedView' },
          ...
          { index: '/manager/spatial-quick-view/cad-preview',         icon: MapLocation, label: 'console.menus.manager.cadPreview' },
          { index: '/manager/model-3d-glb',                           icon: Box,         label: 'console.menus.manager.model3DQuickView' },
