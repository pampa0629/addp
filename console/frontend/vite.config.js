...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/module-health/system':      { target: 'http://localhost:8180', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/manager':     { target: 'http://localhost:8081', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/meta':        { target: 'http://localhost:8082', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/develop':     { target: 'http://localhost:8185', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/transfer':    { target: 'http://localhost:8083', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/service':     { target: 'http://localhost:8086', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/orchestrator':{ target: 'http://localhost:8084', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/monitor':     { target: 'http://localhost:8100', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/standard':    { target: 'http://localhost:8110', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/model':       { target: 'http://localhost:8181', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/agent':       { target: 'http://localhost:8190', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/copilot':     { target: 'http://localhost:8087', rewrite: () => '/health/ready', changeOrigin: true },
      '/module-health/graph':       { target: 'http://localhost:8186', rewrite: () => '/health/ready', changeOrigin: true },
