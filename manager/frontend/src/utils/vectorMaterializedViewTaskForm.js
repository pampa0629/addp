export function createDefaultVectorMaterializedViewTaskForm() {
  return {
    name: '',
    description: '',
    enabled: true,
...
export function createVectorMaterializedViewTaskFormFromTask(task = null) {
  const next = createDefaultVectorMaterializedViewTaskForm()
  if (!task) return next
...
export function createVectorMaterializedViewTaskPayload(form) {
