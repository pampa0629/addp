  ...
  <div class="video-preview">
    ...
    <div v-if="hasMetadata" class="metadata-section">
      <el-divider content-position="left">
        ...
        <span style="margin-left: 8px;">视频信息</span>
      </el-divider>
      ...
      <div class="metadata-grid">
          ...
          <div class="meta-items">
            <div v-if="videoMetadata.resolution" class="meta-row">
              ...
              <span class="meta-value">
                <el-tag size="small" type="info">{{ videoMetadata.resolution }}</el-tag>
              </span>
            </div>
            <div v-if="videoMetadata.duration !== undefined" class="meta-row">
            ...
            <div v-if="videoMetadata.container" class="meta-row">
              <span class="meta-label">容器格式</span>
              <span class="meta-value">
                <el-tag size="small">{{ videoMetadata.container }}</el-tag>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="metadata-group">
          ...
          <div class="meta-items">
            <div v-if="videoMetadata.codec" class="meta-row">
              ...
              <span class="meta-value">
                <el-tag size="small" type="success">{{ videoMetadata.codec }}</el-tag>
              </span>
            </div>
            <div v-if="videoMetadata.bitrate" class="meta-row">
              <span class="meta-label">比特率</span>
              <span class="meta-value">{{ formatBitrate(videoMetadata.bitrate) }}</span>
            </div>
            <div v-if="videoMetadata.frame_rate" class="meta-row">
              <span class="meta-label">帧率</span>
              <span class="meta-value">{{ videoMetadata.frame_rate }} fps</span>
            </div>
          </div>
        </div>
        ...
        <div class="metadata-group">
          <h4>音频信息</h4>
          <div class="meta-items">
            <div v-if="videoMetadata.audio_codec" class="meta-row">
              <span class="meta-label">音频编码</span>
              <span class="meta-value">
                <el-tag size="small" type="warning">{{ videoMetadata.audio_codec }}</el-tag>
              </span>
            </div>
            <div v-if="videoMetadata.audio_channels" class="meta-row">
              <span class="meta-label">音频声道</span>
              <span class="meta-value">{{ formatChannels(videoMetadata.audio_channels) }}</span>
            </div>
            <div v-if="videoMetadata.has_subtitles !== undefined" class="meta-row">
              <span class="meta-label">字幕</span>
              <span class="meta-value">
                <el-tag size="small" :type="videoMetadata.has_subtitles ? 'success' : 'info'">
                  {{ videoMetadata.has_subtitles ? '有' : '无' }}
                </el-tag>
              </span>
            </div>
          </div>
...
const videoSrc = computed(() => {
  ...
  return `/api/manager/video-stream?${params.toString()}`
})
