...
快显FlatGeobuf: GET  /api/v1/manager/quick-view/flatgeobuf?locator={ResourceLocator}
...
3. 从“数据任务 → 向量化任务”入口创建 `manager.embedding_tasks`，TaskProvider `task_type=embedding`。
