        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型过滤：tile_cache_generation|embedding | Task type filter: tile_cache_generation|embedding",
                        "name": "task_type",
                        "in": "query"
                    },
                    {
        ...
        "/tasks/{task_type}/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型：tile_cache_generation|embedding | Task type: tile_cache_generation|embedding",
                        "name": "task_type",
                        "in": "path",
                        "required": true
                    },
