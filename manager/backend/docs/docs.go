        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型过滤：vector_tile_cache_generation|vector_materialized_view_generation|raster_cog_generation|raster_mosaic_generation|model_3d_glb_generation|model_3d_tiles_generation|gaussian_splat_ksplat_generation|point_cloud_copc_generation|embedding | Task type filter",
                        "name": "task_type",
                        "in": "query"
                    },
                    {
        ...
        "/tasks/{task_type}/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型：vector_tile_cache_generation|vector_materialized_view_generation|raster_cog_generation|raster_mosaic_generation|model_3d_glb_generation|model_3d_tiles_generation|gaussian_splat_ksplat_generation|point_cloud_copc_generation|embedding | Task type",
                        "name": "task_type",
                        "in": "path",
                        "required": true
                    },
