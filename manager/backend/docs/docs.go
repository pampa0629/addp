...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/embedding_executions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "一次性向量化执行请求 | Ad-hoc embedding execution request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_service.EmbeddingExecutionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "执行已创建 | Execution created",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_service.EmbeddingExecutionResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
                    ...
                    "503": {
                        "description": "向量化服务不可用 | Embedding service unavailable",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.EmbeddingTaskRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/embeddings": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "页码，默认1 | Page number",
                        "name": "page",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "每页数量，默认20 | Page size",
                        "name": "page_size",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "向量化结果列表 | Embedding result list",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/embeddings/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "向量化结果ID | Embedding result ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/engines/{id}/items/refresh": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "扫描定位（可选，仅支持 item_id）| Scan target (optional, item_id only)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "同步扫描结果 | Synchronous scan result",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_models.MetaScanResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
        ...
        "/engines/{id}/spatial/features/{feature_id}/centroid": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "几何字段名；不传则从 Meta 空间元数据读取 | Geometry column; resolved from Meta spatial metadata when omitted",
                        "name": "geom",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "主键字段名；不传则从 Meta 空间元数据读取 | Primary key column; resolved from Meta spatial metadata when omitted",
                        "name": "primary_key",
                        "in": "query"
                    }
                ],
        ...
        "/executions/{execution_id}/events": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "进度事件 | Progress event",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.RasterMosaicProgressEventRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_api.RasterMosaicProgressEventResponse"
                        }
                    },
                    "400": {
        ...
        "/items/{item_id}/embedding": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "item 向量化状态 | Item embedding state",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/model_3d_glb/{id}/content": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "GLB 内容流 | GLB content stream"
                    },
                    "206": {
                        "description": "部分 GLB 内容流 | Partial GLB content stream"
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
                        "schema": {
                    ...
                    "404": {
                        "description": "GLB 不存在或未就绪 | GLB not found or not ready",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/point_cloud_copc/{id}/content": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "point cloud COPC ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "COPC 内容流 | COPC content stream"
                    },
                    "206": {
                        "description": "部分 COPC 内容流 | Partial COPC content stream"
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
                        "schema": {
                    ...
                    "404": {
                        "description": "COPC 不存在或未就绪 | COPC not found or not ready",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/point_cloud_copc_tasks": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "point cloud COPC generation task configuration",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.PointCloudCOPCTaskRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "创建的任务配置 | Created task configuration",
                        "schema": {
                            "$ref": "#/definitions/internal_api.PointCloudCOPCTaskResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
        ...
        "/preview": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "每页数量，默认20，最大2000 | Page size, default 20, max 2000",
                        "name": "page_size",
                        "in": "query"
                    },
                    {
        ...
        "/quick-view/capability": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "快显能力状态 | Quick view capability state",
                        "schema": {
        ...
        "/quick-view/geojson": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "每页数量，默认1000，最大2000 | Page size, default 1000, max 2000",
                        "name": "page_size",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "headers": {
                            ...
                            "X-ADDP-Tile-Performance-Mode": {
                                "type": "string",
                                "description": "动态瓦片性能模式：ready_3857_target、source_3857_indexed、source_3857_unindexed 或 source_transform_path | Realtime tile performance mode"
                            },
                            ...
                            "X-ADDP-Tile-Retry-Policy": {
                                "type": "string",
                                "description": "超时或降级后的重试策略：suppress_tile 或 ttl | Retry policy after timeout or degraded"
                            },
                            "X-ADDP-Tile-Status": {
                                "type": "string",
        ...
        "/runtime/content-documents/{document_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "内容文档 | Content document",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.ManagerContentDocument"
                        }
                    }
                ],
                "responses": {
        ...
        "/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "限定引擎 ID | Restrict results to an engine ID",
                        "name": "engine_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "搜索结果，results[].locator 为跨引擎资源定位符 | Search results; results[].locator is the cross-engine resource locator",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_service.SearchResult"
                        }
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
        ...
        "/settings/quick-view-policy": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_service.QuickViewPolicyResponse"
                        }
                    }
                },
                "x-addp-auth-mode": "permission",
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "快显策略 | Quick-view policy",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_addp_manager_internal_service.UpdateQuickViewPolicyInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/storage-assets/{engine_id}/{storage_ref}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "存储内容流 | Storage content stream"
                    },
                    "206": {
                        "description": "部分存储内容流 | Partial storage content stream"
                    },
                    "400": {
                        "description": "请求参数错误 | Bad request",
                        "schema": {
        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型过滤：vector_tile_cache_generation|vector_tile_set_generation|vector_materialized_view_generation|raster_cog_generation|raster_mosaic_generation|model_3d_glb_generation|model3d_tiles_generation|gaussian_splat_ksplat_generation|point_cloud_copc_generation|embedding | Task type filter",
                        "name": "task_type",
                        "in": "query"
                    },
                    {
        ...
        "/tasks/{task_type}/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "任务类型：vector_tile_cache_generation|vector_tile_set_generation|vector_materialized_view_generation|raster_cog_generation|raster_mosaic_generation|model_3d_glb_generation|model3d_tiles_generation|gaussian_splat_ksplat_generation|point_cloud_copc_generation|embedding | Task type",
                        "name": "task_type",
                        "in": "path",
                        "required": true
                    },
        ...
        "/vector_tile_cache_tasks": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "瓦片缓存任务配置 | Tile cache task configuration",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "client.ManagerContentDocument": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/client.ManagerContentField"
                    }
                },
                "full_name": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.BooleanMetrics": {
            "type": "object",
            "properties": {
                "false_count": {
                    "type": "integer"
        ...
        "github_com_addp_manager_internal_dataprofile.DataScope": {
            "type": "object",
            "properties": {
                "conditions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.DataScopeCondition"
                    }
                },
                "kind": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.DataScopeCondition": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.DistributionBucket": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "github_com_addp_manager_internal_dataprofile.FieldProfile": {
            "type": "object",
            "properties": {
                "boolean": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.BooleanMetrics"
                },
                ...
                "distribution": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.DistributionBucket"
                    }
                },
                "name": {
                    "type": "string"
                ...
                "numeric": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.NumericMetrics"
                },
                "observations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.Observation"
                    }
                },
                "primary_key": {
                    "type": "boolean"
                ...
                "spatial": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.SpatialMetrics"
                },
                "status": {
                    "type": "string"
                },
                "temporal": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.TemporalMetrics"
                },
                "text": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.TextMetrics"
                },
                "top_values": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.ValueCount"
                    }
                },
                "type": {
                    "$ref": "#/definitions/datatype.FieldType"
        ...
        "github_com_addp_manager_internal_dataprofile.NumericMetrics": {
            "type": "object",
            "properties": {
                "max": {
                    "type": "number"
        ...
        "github_com_addp_manager_internal_dataprofile.Observation": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.Profile": {
            "type": "object",
            "properties": {
                "data_scope": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.DataScope"
                },
                "field_count": {
                    "type": "integer"
                },
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.FieldProfile"
                    }
                },
                "mode": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.SpatialMetrics": {
            "type": "object",
            "properties": {
        ...
        "github_com_addp_manager_internal_dataprofile.TemporalMetrics": {
            "type": "object",
            "properties": {
                "max": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_dataprofile.TextMetrics": {
            "type": "object",
            "properties": {
                "avg_length": {
                    "type": "number"
        ...
        "github_com_addp_manager_internal_dataprofile.ValueCount": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "github_com_addp_manager_internal_models.MetaScanResponse": {
            "type": "object",
            "properties": {
        ...
        "github_com_addp_manager_internal_models.PointCloudCOPC": {
            "type": "object",
            "properties": {
                "content_url": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_service.DataProfileCurrentResponse": {
            ...
            "properties": {
                ...
                "profile": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_dataprofile.Profile"
                },
                "profile_config_hash": {
                    "type": "string"
                },
        ...
        "github_com_addp_manager_internal_service.EmbeddingExecutionRequest": {
            ...
            "properties": {
                ...
                "scope": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_service.EmbeddingExecutionScope"
                },
                "source": {
                    "type": "string"
                },
                "target": {
                    "$ref": "#/definitions/github_com_addp_manager_internal_service.EmbeddingExecutionTarget"
                }
            }
        },
        "github_com_addp_manager_internal_service.EmbeddingExecutionResponse": {
            "type": "object",
            "properties": {
                "execution_id": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_service.EmbeddingExecutionScope": {
            "type": "string",
            "enum": [
                "item",
                "node"
            ...
            "x-enum-varnames": [
                "EmbeddingExecutionScopeItem",
                "EmbeddingExecutionScopeNode"
            ]
        },
        "github_com_addp_manager_internal_service.EmbeddingExecutionTarget": {
            "type": "object",
            "properties": {
                "engine_id": {
                    "type": "integer"
        ...
        "github_com_addp_manager_internal_service.QuickViewModel3DInfo": {
            "type": "object",
            "properties": {
                "file_name": {
                    "type": "string"
        ...
        "github_com_addp_manager_internal_service.QuickViewPointCloudInfo": {
            "type": "object",
            "properties": {
                "bounds_3d": {
                    "$ref": "#/definitions/datatype.Bounds3D"
        ...
        "github_com_addp_manager_internal_service.QuickViewPolicyResponse": {
            "type": "object",
            "properties": {
        ...
        "github_com_addp_manager_internal_service.QuickViewRealtimeTileInfo": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "github_com_addp_manager_internal_service.QuickViewRenderInfo": {
            "type": "object",
            "properties": {
                "extent": {
                    "type": "array",
        ...
        "github_com_addp_manager_internal_service.SearchResult": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_addp_manager_internal_service.SearchDocument"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "github_com_addp_manager_internal_service.TileCacheGeneration": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "github_com_addp_manager_internal_service.UpdateQuickViewPolicyInput": {
            "type": "object",
            "required": [
                "direct_flatgeobuf_max_rows",
                "raster_mosaic_generation_timeout_seconds",
        ...
        "internal_api.Model3DTilesTaskSourceResponse": {
            "type": "object",
            "properties": {
                "format": {
                    "type": "string"
        ...
        "internal_api.PointCloudCOPCTaskRequest": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_addp_common_models.JSONMap"
        ...
        "internal_api.PointCloudCOPCTaskResponse": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_addp_common_models.JSONMap"
                ...
                "result": {
                    "$ref": "#/definitions/internal_api.PointCloudCOPCTaskResultResponse"
                },
                "schedule": {
                    "type": "string"
                },
                "source": {
                    "$ref": "#/definitions/internal_api.PointCloudCOPCTaskSourceResponse"
                },
                "task_type": {
                    "type": "string"
                },
        ...
        "internal_api.PointCloudCOPCTaskResultResponse": {
            "type": "object",
            "properties": {
                "file_name": {
                    "type": "string"
        ...
        "internal_api.PointCloudCOPCTaskSourceResponse": {
            "type": "object",
            "properties": {
                "format": {
                    "type": "string"
        ...
        "internal_api.RasterMosaicProgressEventRequest": {
            "type": "object",
            "properties": {
                "current_file": {
                    "type": "string"
        ...
        "internal_api.RasterMosaicProgressEventResponse": {
            "type": "object",
            "properties": {
                "execution_id": {
                    "type": "string"
        ...
        "internal_api.TileCacheTaskResponse": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_addp_common_models.JSONMap"
                ...
                "target": {
                    "$ref": "#/definitions/internal_api.TileCacheTaskTargetResponse"
                },
                "task_type": {
                    "type": "string"
                },
                ...
                "tile": {
                    "$ref": "#/definitions/internal_api.TileCacheTaskTileResponse"
                },
                "updated_at": {
                    "type": "string"
                }
