...
const (
	...
	MsgProtectionRequired                    = "manager.error.security_protection_required"
	MsgContentDocumentInvalid                = "manager.error.content_document_invalid"
	...
	MsgHybridSearchFailed                    = "manager.error.hybrid_search_failed"
	...
	MsgInvalidTaskID                         = "manager.error.invalid_task_id"
	MsgTaskNotFound                          = "manager.error.task_not_found"
	MsgTaskVersionConflict                   = "manager.error.task_version_conflict"
	MsgTaskBindingStillActive                = "manager.error.task_binding_still_active"
	MsgTaskRebindInvalidRequest              = "manager.error.task_rebind_invalid_request"
	MsgTaskRebindUnsupportedType             = "manager.error.task_rebind_unsupported_type"
	MsgTaskRebindCapabilityMismatch          = "manager.error.task_rebind_capability_mismatch"
	MsgTaskRebindUnavailable                 = "manager.error.task_rebind_unavailable"
	MsgTaskRebindFailed                      = "manager.error.task_rebind_failed"
