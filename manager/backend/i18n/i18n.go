...
const (
	...
	MsgTileConfigFailed            = "manager.error.tile_config_failed"
	...
	MsgQuickViewPreparationNeeded  = "manager.error.quick_view_preparation_needed"
	MsgQuickViewAlreadyGenerating  = "manager.error.quick_view_already_generating"
	MsgQuickViewMinZoomRequired    = "manager.error.quick_view_min_zoom_required"
	MsgQuickViewMaxZoomRequired    = "manager.error.quick_view_max_zoom_required"
	MsgQuickViewCancelStatus       = "manager.error.quick_view_cancel_status"
	MsgQuickViewResumeStatus       = "manager.error.quick_view_resume_status"
