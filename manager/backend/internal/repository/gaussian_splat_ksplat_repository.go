...
func (r *GaussianSplatKSplatRepository) StartExecution(
	...
	return newTaskExecutionLifecycle(r.db).Start(
		ctx, taskID, tenantID, executionID, startedAt, &models.GaussianSplatKSplatTask{}, "gaussian splat KSplat",
	)
}

func (r *GaussianSplatKSplatRepository) CompleteExecution(
	ctx context.Context,
	...
	return newTaskExecutionLifecycle(r.db).Complete(ctx, taskID, tenantID, executionID, completedAt, taskExecutionCompletionSpec{
		TaskModel:       &models.GaussianSplatKSplatTask{},
		ResultModel:     &models.GaussianSplatKSplat{},
		ResultID:        resultID,
