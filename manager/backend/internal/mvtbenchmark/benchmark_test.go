...
func TestRunBuildsSourceTransformAnd3857TargetQueries(t *testing.T) {
	cfg := NormalizeConfig(Config{
		...
		Scenarios: []Scenario{
			...
			{
				Name:           "ready 3857",
				TargetKind:     "ready_3857_optimization",
				Schema:         "public",
	...
	if report.Scenarios[1].RenderPath != "ready_3857_optimization" {
		t.Fatalf("render path = %s, want ready_3857_optimization", report.Scenarios[1].RenderPath)
	}
