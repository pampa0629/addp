...
func TestManagerErrorMessagesRegistered(t *testing.T) {
	...
	messageIDs := []string{
		...
		manageri18n.MsgTileConfigFailed,
		manageri18n.MsgParseFormFailed,
		manageri18n.MsgFileRequired,
		manageri18n.MsgReadFileFailed,
		manageri18n.MsgTargetEngineIDRequired,
		manageri18n.MsgInvalidTargetEngineID,
		...
		manageri18n.MsgQuickViewPreparationNeeded,
		manageri18n.MsgQuickViewAlreadyGenerating,
		manageri18n.MsgQuickViewMinZoomRequired,
		manageri18n.MsgQuickViewMaxZoomRequired,
		manageri18n.MsgQuickViewCancelStatus,
		manageri18n.MsgQuickViewResumeStatus,
		...
		manageri18n.MsgImportSourceNotConfigured,
		manageri18n.MsgImportSourceNotMatched,
		manageri18n.MsgImportSourceAmbiguous,
		manageri18n.MsgImportSourceIDInvalid,
		manageri18n.MsgImportSourceInactive,
