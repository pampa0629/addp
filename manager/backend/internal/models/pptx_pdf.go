...
type PPTXPDF struct {
	...
	TaskID          uint   `gorm:"not null;index:idx_pptx_pdf_task" json:"task_id"`
	LastExecutionID string `gorm:"size:36;not null;index:idx_pptx_pdf_execution" json:"last_execution_id"`
